...
+ **New!** [Split-AE](gdl4designapps/preprocess_methods.py#L3129): This class contains the functions to generate the parameters and corresponding Tensorflow graph for training Split-AE, an architecture that generates content and style features of the input 3D point cloud representations for style transfer.
